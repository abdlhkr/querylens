export const en = {
  ...
  auth: {
    ...
    verify_hint: 'Enter the 6-digit code sent to {{email}}',
    verify_btn: 'Verify',
    verification_code: 'Verification Code',
    forgot_title: 'Forgot Password',
    forgot_hint: "Enter your email and we'll send you a reset code.",
    send_code: 'Send Code',
  ...
  app: {
    ...
    set_password_desc: 'Set a password so you can also sign in with email and password in addition to Google.',
    change_email: 'Change Email',
    change_email_desc: 'Update the email address associated with your account.',
  ...
  errors: {
    ...
    code_incomplete: 'Please enter all 6 digits.',
  },
  common: {
    loading: 'Loading...',
    success: 'Success!',
